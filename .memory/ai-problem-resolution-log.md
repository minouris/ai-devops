...
### LOG-2026-02-23-03
**Date:** 2026-02-23
**Operation:** Solutions-history fact file split into problem-specific sub-files
**Files changed:** `.memory/ai-problem-resolution-solutions-history-facts.md`, `.memory/ai-problem-resolution-solutions-history-hallucination-facts.md` (new), `.memory/ai-problem-resolution-solutions-history-overeagerness-facts.md` (new), `.memory/ai-problem-resolution-solutions-history-amnesia-facts.md` (new), `.memory/ai-problem-resolution-index.md`
**Summary:** Split the 1,191-line solutions-history fact file into an overview plus three problem-specific sub-files. (1) Created hallucination sub-file: FINDING-06 (earliest NO GUESSING POLICY wording deficiencies — 6 failure modes) and FINDING-07 (8-revision policy evolution R1–R8 across all five projects). (2) Created overeagerness sub-file: FINDING-03 (language directives dual purpose), FINDING-12 (ai-targeted-language as structural compliance enabler), FINDING-13 (compliance gates evolution). (3) Created amnesia sub-file: FINDING-10 (three amnesia root causes — deprioritisation/truncation/positional, context flooding, paraphrase degradation) and FINDING-11 (11-factor degradation taxonomy across Availability/Budget/Framing/Scope categories). Overview file trimmed from 1,191 to ~989 lines: removed 7 problem-specific findings, replaced each with a one-line redirect to the appropriate sub-file, added Sub-topic Fact Files reference table after Amnesia Attempts section. Cross-cutting findings retained in overview: FINDING-01, 02, 04, 05, 08, 09. Index updated with sub-file entries and session 8 note.
**Next:** Pending — SH-039/040/041 catalog entries; SH-038/031 miscategorisation correction; evolution analysis of meta-instructional files; consolidate-clarifications prompt.
...
### LOG-2026-02-23-04
**Date:** 2026-02-23
**Operation:** New finding — Context Poisoning relationship to solutions history
**Files changed:** `.memory/ai-problem-resolution-solutions-history-facts.md`
