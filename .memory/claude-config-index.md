...
- [claude-config-subagents-facts.md](.memory/claude-config-subagents-facts.md) — Subagents (findings 25-37) ✅ VERIFIED 2026-03-05
- [claude-config-commands-facts.md](.memory/claude-config-commands-facts.md) — Commands (findings 38-44) ✅ VERIFIED 2026-03-05
...
**Verified findings:** 69 (skills: 16, rules: 13, hooks: 15, subagents: 13, commands: 7, skills-vs-rules: 5 derived)
**Unverified findings:** 35 (claudemd: 13, plugins: 13, compaction: 10 - 1 pending exploration)
