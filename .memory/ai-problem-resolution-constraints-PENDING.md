...
**Sources:** [.memory/ai-problem-resolution-solutions-history-hallucination-facts.md](.memory/ai-problem-resolution-solutions-history-facts.md), [.memory/ai-problem-resolution-solutions-history-overeagerness-facts.md](.memory/ai-problem-resolution-solutions-history-overeagerness-facts.md), [.memory/ai-problem-resolution-solutions-history-amnesia-facts.md](.memory/ai-problem-resolution-solutions-history-amnesia-facts.md), [.memory/ai-problem-resolution-root-causes-facts.md](.memory/ai-problem-resolution-root-causes-facts.md), [.memory/ai-problem-resolution-solutions-history-facts.md](.memory/ai-problem-resolution-solutions-history-facts.md)
...
- [.memory/ai-problem-resolution-solutions-history-hallucination-facts.md](.memory/ai-problem-resolution-solutions-history-hallucination-facts.md) — Hallucination and Dishonesty policy evolution (FINDING-06: language deficiencies in earliest NO GUESSING POLICY; FINDING-07: 8-revision documentation-first policy evolution)
- [.memory/ai-problem-resolution-solutions-history-overeagerness-facts.md](.memory/ai-problem-resolution-solutions-history-overeagerness-facts.md) — Overeagerness solutions (FINDING-03: language directives dual purpose; FINDING-12: AI-targeted language as structural compliance enabler; FINDING-13: compliance gates evolution)
- [.memory/ai-problem-resolution-solutions-history-amnesia-facts.md](.memory/ai-problem-resolution-solutions-history-amnesia-facts.md) — Amnesia solutions (FINDING-10: three root causes — instruction deprioritisation, context flooding, paraphrase degradation; FINDING-11: 11-factor degradation taxonomy across four categories)
- [.memory/ai-problem-resolution-root-causes-facts.md](.memory/ai-problem-resolution-root-causes-facts.md) — Root cause definitions, unified root cause analysis (training optimisation for "helpfulness"), Context Poisoning mechanism (FINDING-2026-02-20-09)
- [.memory/ai-problem-resolution-solutions-history-facts.md](.memory/ai-problem-resolution-solutions-history-facts.md) — Solutions catalog SH-001 through SH-038; FINDING-SH-M-2026-02-23-02 (Context Poisoning relationship to first/second-wave solutions); methodology findings and evolution framework
