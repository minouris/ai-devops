...
|---------|-------|------|-------|
| [FINDING-2026-04-08-1](./workflow-execution/workflow-execution-facts.md#finding-2026-04-08-1) | Custom Actions | GitHub Actions overview and custom actions | [Custom actions](#custom-actions) |
| [FINDING-2026-04-08-2](./workflow-execution/workflow-execution-facts.md#finding-2026-04-08-2) | Workflow Syntax | GitHub Workflow file structure and core properties | [Workflow file](#workflow-file) |
| [FINDING-2026-04-08-3](./workflow-execution/workflow-execution-facts.md#finding-2026-04-08-3) | Event Triggers | Event triggers and custom inputs in workflows | [Event triggers](#event-triggers), [Workflow_dispatch trigger](#workflow_dispatch-trigger) |
| [FINDING-2026-04-08-4](./workflow-execution/workflow-execution-facts.md#finding-2026-04-08-4) | Command Execution | Executing commands in workflow steps | [Run keyword](#run-keyword) |
| [FINDING-2026-04-08-5](./workflow-execution/workflow-execution-facts.md#finding-2026-04-08-5) | Step Configuration | Invoking custom actions and passing inputs to steps | [Uses keyword](#uses-keyword), [Steps](#steps) |
| [FINDING-2026-04-08-6](./copilot-cli/copilot-cli-facts.md#finding-2026-04-08-6) | AI Integration | GitHub Copilot functionality and GitHub integration | [GitHub Copilot](#github-copilot) |
| [FINDING-2026-04-08-7](./copilot-cli/copilot-cli-facts.md#finding-2026-04-08-7) | Copilot Automation | Running GitHub Copilot CLI in GitHub Actions workflows | [Copilot CLI invocation](#copilot-cli-invocation), [`--no-ask-user` flag](#--no-ask-user-flag), [`COPILOT_GITHUB_TOKEN` environment variable](#copilot_github_token-environment-variable), [npm installation of Copilot CLI](#npm-installation-of-copilot-cli) |
| [FINDING-2026-04-08-8](./copilot-cli/copilot-cli-facts.md#finding-2026-04-08-8) | Model Configuration | Specifying model in Copilot CLI for GitHub Actions workflows | [`--model` flag](#--model-flag), [`COPILOT_MODEL` environment variable](#copilot_model-environment-variable), [Model selection priority](#model-selection-priority) |
| [FINDING-2026-04-09-1](./copilot-cli/copilot-cli-facts.md#finding-2026-04-09-1) | Custom Instructions | Custom instructions configuration for Copilot CLI | [Custom instructions](#custom-instructions) |
| [FINDING-2026-04-09-2](./copilot-cli/copilot-cli-facts.md#finding-2026-04-09-2) | Instructions Directory | Specifying custom instructions directories for Copilot CLI | [Custom instructions](#custom-instructions), [`COPILOT_CUSTOM_INSTRUCTIONS_DIRS` environment variable](#copilot_custom_instructions_dirs-environment-variable) |
| [FINDING-2026-04-08-1](./github-cli/github-cli-facts.md#finding-2026-04-08-1) | GitHub CLI | GitHub CLI preinstallation and setup requirement | [GitHub CLI preinstallation](#github-cli-preinstallation) |
| [FINDING-2026-04-08-2](./github-cli/github-cli-facts.md#finding-2026-04-08-2) | CLI Authentication | Authenticating GitHub CLI with GH_TOKEN in workflows | [`GH_TOKEN` environment variable](#gh_token-environment-variable), [`GITHUB_TOKEN` automatic token](#github_token-automatic-token) |
