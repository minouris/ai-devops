# Claude Config Facts: Composition - Official Claude Documentation

Official Claude prompt engineering best practices from platform.claude.com documentation.
...
**Status:** Split from composition-facts.md (official findings only)
**Total findings:** 29 findings from official Claude documentation
