...
- **directory** (4 findings)
- **disable** (1 finding)
- **discovery** (1 finding)
- **distribution** (2 findings)
...
- **format** (3 findings)
- **framework** (1 finding)
- **frontmatter** (3 findings)
- **generation** (1 finding)
- **git** (1 finding)
- **guideline** (2 findings)
- **handler** (1 finding)
- **hierarchy** (3 findings)
- **history** (1 finding)
- **hook** (17 findings)
- **http** (2 findings)
...
- **strategy** (1 finding)
- **streaming** (1 finding)
- **structure** (7 findings)
- **subagent** (15 findings)
